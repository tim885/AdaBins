...
if __name__ == "__main__":
    ...
    url = "https://drive.google.com/drive/folders/1nYyaQXOBjNdUJDsmJpcRpu6oE55aQoLA?usp=sharing"
    file_id = "1nYyaQXOBjNdUJDsmJpcRpu6oE55aQoLA"

    if len(sys.argv) is not 2:
        print("Usage: python download_from_gdrive.py destination_file_path (e.g., ./name.zip)")
    else:
        # DESTINATION FILE ON YOUR DISK
        desti = sys.argv[1]
        download_file_from_google_drive(url, file_id, desti)
